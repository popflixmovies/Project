...
var CDropdownToggle = function (_a) {
    ...
    var _e = React.useContext(CDropdownContext.CDropdownContext), dropdownToggleRef = _e.dropdownToggleRef, handleHide = _e.handleHide, handleShow = _e.handleShow, variant = _e.variant, visible = _e.visible;
    var triggers = tslib_es6.__assign(tslib_es6.__assign({}, ((trigger === 'click' || trigger.includes('click')) && {
        ...
        onFocus: function () { return handleShow === null || handleShow === void 0 ? void 0 : handleShow(); },
        onBlur: function () { return handleHide === null || handleHide === void 0 ? void 0 : handleHide(); },
    }));
